            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><strong>
                        ...
                        <div class="col-lg-12">
                            <input type="text" aria-label="Quiz Title" value="Untitled quiz -2017-01-25-04-45-36" id="quizTitleInput" class="st eIcon"      data-oldvalue="Untitled quiz -2017-01-25-04-45-36">
                                <p class="text timeLabel">Time Limit:</p>
                                    <input type="text" aria-label="Time Limit:" id="timeLimitMins" value="" class="st" data-oldvalue="60">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form action="Onlineexamtable.php" method=post>
                           <?php  
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <span id="totalPoints" class="ttip" data-ttip="Quiz total points ">1</span>

                                        <div class="textareaWrap">
                                    <textarea aria-label="About this Quiz" id="aboutQuizInput" class="st" maxlength="4096" data-oldvalue="" default_height="73"></textarea>
